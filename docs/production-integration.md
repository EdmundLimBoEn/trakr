...
The included app is the full iOS workflow MVP. These external systems require school-owned credentials and must be connected before live deployment:
...
The UI and Core NFC adapter do not require redesign when the backend is swapped.
