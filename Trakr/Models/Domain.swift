...
enum TrakrError: LocalizedError, Equatable {
    case invalidEmail
    ...
    var errorDescription: String? {
        ...
        case .invalidTagPayload: "This is not a Trakr tag."
...
enum RoleDeriver {
    static func role(for email: String) throws -> UserRole {
        ...
        guard parts.count == 2, !parts[0].isEmpty else { throw TrakrError.invalidEmail }
...
enum TagCodec {
    ...
    static func generate() -> String {
        "tr:" + String((0..<26).map { _ in alphabet.randomElement()! })
    }

    static func isValid(_ value: String) -> Bool {
        guard value.hasPrefix("tr:"), value.count == 29 else { return false }
